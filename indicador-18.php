...
Highcharts.chart('lesly', {
    ...
    title: {
        text: 'Porcentaje de reclamos y quejas atendidos oportunamente'
    },
    subtitle: {
        text: ''
    },
    ...
    yAxis: {
        min: 0,
        title: {
            text: 'N° de quejas y reclamos respondidos / N° de quejas y reclamos totales  <br> Porcentaje'
        }
    },
    legend: {
        enabled: false
    ...
    tooltip: {
        pointFormat: 'Porcentaje de reclamos y quejas: <b>{point.y:.1f} %</b>'
    },
    credits: {
        enabled: false
    },
