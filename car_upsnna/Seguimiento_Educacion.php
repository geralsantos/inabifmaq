                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="NNAIntervencion" id="NNAIntervencion" class="form-control">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="NNASistemaEducativo" id="NNASistemaEducativo" class="form-control">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="NNANivelCrusa" id="NNANivelCrusa" class="form-control">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="text-input" class=" form-control-label">Grado </label>
                                        <select name="NNAGrado" id="NNAGrado" class="form-control">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="text-input" class=" form-control-label">Acude en el mes al centro de estudios?</label>
                                        <select name="NNAAcudeEstudio" id="NNAAcudeEstudio" class="form-control">
                                        <option value="">SI</option>
                                        <option value="">NO</option>
                                        </select> 
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="text-input" class=" form-control-label">Se encuentran participando de entrenamiento profesional/técnico</label>
                                        <select name="NNAEntrenamientoProfesional" id="NNAEntrenamientoProfesional" class="form-control">
