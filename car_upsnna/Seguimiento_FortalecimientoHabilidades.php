                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="NNAParticipaActividades" id="NNAParticipaActividades" class="form-control">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" id="NNAFInicioFortalecimiento" name="NNAFInicioFortalecimiento" placeholder="" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" id="NNAFFinalFortalecimiento" name="NNAFFinalFortalecimiento" placeholder="" class="form-control">  </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="text-input" class=" form-control-label">NNA conluyó actividades de fortalecimiento de habilidades personales y sociales </label>
                                        <select name="NNAConcluyoActividades" id="NNAConcluyoActividades" class="form-control">
                                        <option value="">Si</option>
                                        <option value="">No</option>
                                        </select> 
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="text-input" class=" form-control-label">NNA logró fortalecer sus habilidades personales y sociales?</label>
                                        <select name="NNAHabilidadesPersonales" id="NNAHabilidadesPersonales" class="form-control">
                                        <option value="">SI</option>
                                        <option value="">NO</option>
                                        </select> 
                                </div>
