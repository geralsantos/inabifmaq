                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="CarEnfermedadesCronicas" id="CarEnfermedadesCronicas" class="form-control">
                                        <option value="">Si</option>
                                        <option value="">No</option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="CarEspecificarEnfermedad" name="CarEspecificarEnfermedad" placeholder="" class="form-control">
                                </div>
                            </div>
