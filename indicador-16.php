        ...
        <div class="content mt-3">
            <div class="col-lg-12">
                    <div class="card">
                        ...
                        <strong>Porcentaje de sugerencias atendidas oportunamente</strong>
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <div class=""><label for="text-input" class=" form-control-label">Sugerencias Respondidas</label><input type="number" id="txtmeta" name="txtmeta" placeholder="" class="form-control"> </div>
                                </div>
                                <div class="form-group col-md-4">
